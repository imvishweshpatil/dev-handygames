...
const Navbar = () => {
    return (
        <Popover>
            <div className="header-container fixed w-full flex top-0 items-center pt-5 h-14 z-50">
                <Image src={"/kidalogo.png"} alt={"KIDAStudios"} className="kidalogo" width={90} height={90} style={{marginTop:"20px", marginLeft:"20px"}}/>
                {/*<div className="grow">
